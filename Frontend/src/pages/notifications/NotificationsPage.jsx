...
const emitUnreadDelta = (delta) => {
    window.dispatchEvent(
        new CustomEvent("notifications:unread-delta", {
            detail: { delta },
        })
    );
};
                    ...
                    <header className="shrink-0 bg-[#121212] pb-6">
                        <div className="flex items-start justify-between gap-5">
                            <div className="min-w-0">
                                <h1 className="text-[34px] font-black leading-10 tracking-tight text-white max-sm:text-2xl">
                                    Có gì mới
                                </h1>
