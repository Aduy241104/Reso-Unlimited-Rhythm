...
const UserProfileAvatar = ({ avatar, fullName, email }) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-[24px] border border-white/10 bg-[linear-gradient(160deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03)_38%,rgba(8,8,8,0.96)_100%)] p-4 text-center shadow-[0_28px_80px_rgba(0,0,0,0.34)] sm:rounded-[30px] sm:p-8 xl:sticky xl:top-8">
      ...
      <div className="relative mx-auto flex max-w-[18rem] flex-col items-center">
        ...
        <h2 className="mt-5 break-words text-2xl font-semibold tracking-tight text-white sm:mt-7 sm:text-[2rem]">
          {resolvedFullName}
        </h2>

        <div className="mt-3 inline-flex max-w-full items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-sm text-white/72">
          <Mail className="h-4 w-4 text-white/70" aria-hidden />
          <span className="min-w-0 truncate">{resolvedEmail}</span>
        </div>
