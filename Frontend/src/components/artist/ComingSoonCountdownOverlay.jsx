        ...
        >
          ...
          >
            ...
            <div className="relative space-y-3 text-left">
              ...
              {!hasScheduledRelease ? (
                <div className="max-w-full break-words rounded-[1.2rem] border border-dashed border-white/12 bg-black/28 px-4 py-4 text-sm text-white/58">
                  No scheduled coming release.
                </div>
              ) : null}
