...
const RegisterOtpStep = ({
  ...
  return (
    ...
    >
      <div className="mb-5 rounded-2xl border border-sky-300/20 bg-sky-400/10 px-4 py-3 text-sm text-sky-100">
      ...
      <div className="mt-4 flex flex-col gap-3 sm:flex-row">
        <button
          className="inline-flex items-center justify-center rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm font-medium text-[#efe7dc] transition hover:border-white/20 hover:bg-white/[0.06]"
        ...
        <button
          className="inline-flex items-center justify-center rounded-2xl border border-[#f5b66f]/25 bg-[#f5b66f]/8 px-4 py-3 text-sm font-medium text-[#f5b66f] transition hover:bg-[#f5b66f]/14 disabled:cursor-not-allowed disabled:border-white/10 disabled:bg-white/[0.03] disabled:text-[#7c7680]"
