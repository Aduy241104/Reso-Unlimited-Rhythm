...
import { createAdminGenreService } from "../../services/adminGenreService";
...
const CreateGenrePage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      let imageUrl = "";
      if (coverFile) {
        imageUrl = await uploadToCloudinary(coverFile, "image");
      }
            ...
            {coverPreview ? (
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <div className="flex flex-1 items-center justify-between gap-3">
                  <p className="text-sm text-black/70">Selected image will be uploaded to Cloudinary.</p>
