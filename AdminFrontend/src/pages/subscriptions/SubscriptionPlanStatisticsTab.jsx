...
const SubscriptionPlanStatisticsTab = () => {
    ...
    return (
        <section className="space-y-4">
            <div className="flex flex-col gap-3 rounded-2xl bg-white p-5 shadow-[0_12px_30px_rgba(15,23,42,0.05)] sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <div className="flex items-center gap-2 text-slate-500">
                        <BarChart3 size={18} />
                        <p className="text-sm font-semibold">Thống kê lượt đăng ký theo gói</p>
                    </div>
                    <p className="mt-1 text-sm text-slate-500">
                        Bao gồm cả các subscription đã hết hạn để admin theo dõi đầy đủ vòng đời gói đăng ký.
                    </p>
                </div>
