...
import { listenPodcastSchema, podcastIdParamSchema, podcastStreamSchema, publicPodcastQuerySchema } from "../middlewares/podcast.validation.js";
...
router.post("/:id/stream", optionalAuthenticate(), validate(podcastIdParamSchema, "params"), validate(podcastStreamSchema, "body"), podcastController.stream);
